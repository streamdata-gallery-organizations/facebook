...
x-complete: 0
info:
  title: Facebook Get User Veo Broadcasts
...
paths:
  ...
  /&#123;user-id&#125;/television:
    get:
      ...
      x-api-path-slug: 123userid125television-get
      parameters:
      - in: query
        name: created_timedatetime
        description: Time the object liked the pageDefault
  ...
  /&#123;user-id&#125;/threads:
    get:
      ...
      x-api-path-slug: 123userid125threads-get
      parameters:
      - in: query
        name: "100"
        description: Invalid parameter
      ...
      - User
      - Threads
  /&#123;user-id&#125;/video_broadcasts:
    get:
      summary: Get User Veo Broadcasts
      description: User Video Broadcasts
      operationId: getUserVeoBroadcasts
      x-api-path-slug: 123userid125video-broadcasts-get
      parameters:
      - in: query
        name: "100"
        description: Invalid parameter
